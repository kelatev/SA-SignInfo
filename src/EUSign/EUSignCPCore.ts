...
export default class EUSignCPCore {
  ...
  Load(): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      if (this.m_library == null) {
        const loader = new EndUserLibraryLoader(
        ...
        loader.onerror = (msg, errorCode, libraryOrNull) => {
          ...
          reject({ full: msg, short: libraryOrNull.MakeError(errorCode, "") });
        };
        loader.load();
      } else {
        resolve();
  ...
  SetOCSPAccessInfoModeSettings(
    settings: EndUserOCSPAccessInfoModeSettings
  ): Promise<void> {
    return new Promise((resolve, reject) => {
  ...
  GetOCSPAccessInfoSettings(
    issuerCN: string
  ): Promise<EndUserOCSPAccessInfoSettings> {
    return new Promise((resolve, reject) => {
  ...
  SetOCSPAccessInfoSettings(
    settings: EndUserOCSPAccessInfoSettings
  ): Promise<void> {
    return new Promise((resolve, reject) => {
  ...
  GetCertificatesCount2(
    subjectType: number,
    SubjectSubType: number
  ): Promise<number> {
    return new Promise((resolve, reject) => {
      this.m_library.GetCertificatesCount(
        subjectType,
        SubjectSubType,
        resolve,
        reject
  ...
  GetCertificateInfo(
    issuer: string,
    serial: string
  ): Promise<EndUserCertificateInfo> {
    return new Promise((resolve, reject) => {
  ...
  GetCertificateInfoEx(
    issuer: string,
    serial: string
  ): Promise<EndUserCertificateInfoEx> {
    return new Promise((resolve, reject) => {
  ...
  CheckCertificateByIssuerAndSerial(
    ...
    return new Promise((resolve, reject) => {
      this.m_library.CheckCertificateByIssuerAndSerial(
        issuer,
        serial,
        resolve,
        reject
  ...
  GetCertificates(
    ...
    return new Promise((resolve, reject) => {
      this.m_library.GetCertificates(
        subjectType,
        subjectSubType,
        resolve,
        reject
  ...
  EnumCAServerCertificates(
    certificateIndex: number
  ): Promise<EndUserOwnerInfo> {
    return new Promise((resolve, reject) => {
      this.m_library.EnumCAServerCertificates(
        certificateIndex,
        resolve,
        reject
      );
  ...
  EnumCMPServerCertificatesCount(
    certificateIndex: number
  ): Promise<EndUserOwnerInfo> {
    return new Promise((resolve, reject) => {
      this.m_library.EnumCMPServerCertificatesCount(
        certificateIndex,
        resolve,
        reject
      );
  ...
  EnumOCSPServerCertificatesCount(
    certificateIndex: number
  ): Promise<EndUserOwnerInfo> {
    return new Promise((resolve, reject) => {
      this.m_library.EnumOCSPServerCertificatesCount(
        certificateIndex,
        resolve,
        reject
      );
  ...
  EnumTSPServerCertificatesCount(
    certificateIndex: number
  ): Promise<EndUserOwnerInfo> {
    return new Promise((resolve, reject) => {
      this.m_library.EnumTSPServerCertificatesCount(
        certificateIndex,
        resolve,
        reject
      );
  ...
  EnumRAAdministratorCertificatesCount(
    certificateIndex: number
  ): Promise<EndUserOwnerInfo> {
    return new Promise((resolve, reject) => {
      this.m_library.EnumRAAdministratorCertificatesCount(
        certificateIndex,
        resolve,
        reject
      );
  ...
  EnumEndUserCertificatesCount(
    certificateIndex: number
  ): Promise<EndUserOwnerInfo> {
    return new Promise((resolve, reject) => {
      this.m_library.EnumEndUserCertificatesCount(
        certificateIndex,
        resolve,
        reject
      );
  ...
  EnumKeyMediaDevices(
    typeIndex: number,
    deviceIndex: number
  ): Promise<EndUserKeyMedia> {
    return new Promise((resolve, reject) => {
      this.m_library.EnumKeyMediaDevices(
        typeIndex,
        deviceIndex,
        resolve,
        reject
  ...
  // Зчитування особистого ключа за параметрами особистого ключа без використання
  // графічного інтерфейсу
  ReadPrivateKeySilently2(
    typeIndex: number,
    devIndex: number,
    password: string
  ): Promise<void> {
    return new Promise((resolve, reject) => {
      this.m_library.ReadPrivateKeySilently(
        typeIndex,
        devIndex,
        password,
        resolve,
  ...
  ReadPrivateKeyBinary(
    ...
    return new Promise((resolve, reject) => {
      this.m_library.ReadPrivateKeyBinary(
        privateKey,
        password,
        resolve,
        reject
  ...
  IsHardwareKeyMedia(
    ...
    return new Promise((resolve, reject) => {
      this.m_library.IsHardwareKeyMedia(
        typeIndex,
        devIndex,
        password,
        resolve,
  ...
  IsPrivateKeyExists(
    ...
    return new Promise((resolve, reject) => {
      this.m_library.IsPrivateKeyExists(
        typeIndex,
        devIndex,
        password,
        resolve,
  ...
  GetKeyInfoSilently(
    ...
    devIndex: number,
    password: string
  ): Promise<EndUserPrivateKeyInfo> {
    return new Promise((resolve, reject) => {
      this.m_library.GetKeyInfoSilently(
        typeIndex,
        devIndex,
        password,
        resolve,
  ...
  IsDataInSignedFileAvailable(
    fileNameWithSignedData: string
  ): Promise<boolean> {
    return new Promise((resolve, reject) => {
      this.m_library.IsDataInSignedFileAvailable(
        fileNameWithSignedData,
        resolve,
        reject
      );
    });
  ...
  GetDataFromSignedFile(
    fileNameWithSignedData: string,
    fileNameWithData: string
  ): Promise<string> {
    return new Promise((resolve, reject) => {
      this.m_library.GetDataFromSignedFile(
        fileNameWithSignedData,
        fileNameWithData,
        resolve,
        reject
  ...
  GetCertificateFromSignedData(
    ...
    return new Promise((resolve, reject) => {
      this.m_library.GetCertificateFromSignedData(
        index,
        signedData,
        resolve,
        reject
  ...
  GetCertificateFromSignedFile(
    ...
    return new Promise((resolve, reject) => {
      this.m_library.GetCertificateFromSignedFile(
        index,
        fileNameWithSignedData,
        resolve,
        reject
  ...
  GetFileSignTimeInfo(
    index: number,
    fileNameWithSignedData: string
  ): Promise<EndUserTimeInfo> {
    return new Promise((resolve, reject) => {
      this.m_library.GetFileSignTimeInfo(
        index,
        fileNameWithSignedData,
        resolve,
        reject
