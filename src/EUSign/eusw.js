...
JSONRPCClient.prototype.verifyResponse = function (request_id, response) {
    try {
        ...
        let error = response[JSON_RPC_FIELD_NAME_ERROR];
...
export const EndUserLibraryLoader = function (libraryType, id, language,
...
export var EndUserCertificateInfoEx = function () {
...
export const EndUserError = function (errorCode, message) {
...
export const EUSignCP = function (address, port) {
    this.vendor = 'JSC IIT';
...
EUSignCP.prototype.SetCharset = function (
    ...
    let coder;
    const isAsync = this.IsAsync(onSuccess, onError);
