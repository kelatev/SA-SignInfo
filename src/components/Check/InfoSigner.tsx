        ...
        <>
            ...
            >
                {props.data.GetSubjDRFOCode() && props.data.GetSubjDRFOCode() !== props.data.GetSubjEDRPOUCode() && (
                    <RowDescription
                        title={"РНОКПП"}
                        description={props.data.GetSubjDRFOCode()}
                    />
                )}
                <RowDescription
                    title={"Організація (установа)"}
                    description={props.data.GetSubjOrg()}
                />
                {props.data.GetSubjEDRPOUCode() && (
                    <RowDescription
                        title={"Код ЄДРПОУ"}
                        description={props.data.GetSubjEDRPOUCode()}
                    />
                )}
            </TimelineItem>
            <TimelineItem
            ...
            >
                ...
                <RowDescription
                    ...
                    description={euSign?.GetSignAlgo(props.data) || ""}
                />
            ...
            >
                <RowDescription
                    ...
                    description={props.data.GetIssuerCN()}
                />
                <RowDescription
                    title={"Серійний номер"}
                    description={props.data.GetSerial()}
                />
                {/*<RowDescription title={'Тип носія особистого ключа'} description={''}/>*/}
                {/*<RowDescription title={'Тип підпису'} description={''}/>
            <RowDescription title={'Тип контейнера'} description={''}/>
