 ...
 */
                    i = function() {
                        ...
                        var i = Array.isArray ? Array.isArray : function(c) {
                            ...
                            , u = d || {}
                            , o = u.MutationObserver || u.WebKitMutationObserver
                        ...
                        l ? E = function() {
                            ...
                            : o ? (j = 0,
                            ...
                            ) : s ? ((m = new MessageChannel).port1.onmessage = k,
                                    E = function() {
                                ...
                                try {
                                    var c = a(23);
                                    return n = c.runOnLoop || c.runOnContext,
                                        function() {
                                            n(k)
                                        }
                                } catch (c) {
                        ...
                        function N(e, a, r) {
                            a.constructor === e.constructor && r === _ && a.constructor.resolve === K ? function(c, e) {
                                1 === e._state ? R(c, e._result) : 2 === e._state ? q(c, e._result) : I(e, void 0, (function(e) {
                                        return A(c, e)
                                    }
                                ), (function(e) {
                                        return q(c, e)
                            ...
                            }(e, a) : r === P ? q(e, P.error) : void 0 === r ? R(e, a) : c(r) ? function(c, e, a) {
                                f((function(c) {
                                        var r = !1
                                            , i = function(c, e, a, r) {
                                            try {
                        ...
                        function A(c, e) {
                            var a;
                            c === e ? q(c, new TypeError("You cannot resolve a promise with itself")) : "function" == typeof (a = e) || "object" == typeof a && null !== a ? N(c, e, S(e)) : R(c, e)
                        }
                        function C(c) {
                        ...
                        function R(c, e) {
                            void 0 === c._state && (c._result = e,
                                c._state = 1,
                            0 !== c._subscribers.length && f(x, c))
                        }
                        function q(c, e) {
                            void 0 === c._state && (c._state = 2,
                                c._result = e,
                                f(C, c))
                        }
                        function I(c, e, a, r) {
                        ...
                        function M(e, a, r, i) {
                            ...
                            if (t) {
                                if ((n = function(c, e) {
                                    ...
                                    n = null) : f = !0,
                                a === n)
                                    return void q(a, new TypeError("A promises callback cannot return that same promise."))
                            } else
                                n = i,
                                    f = !0;
                            void 0 !== a._state || (t && f ? A(a, n) : d ? q(a, b) : 1 === e ? R(a, n) : 2 === e && q(a, n))
                        }
                        var O = 0;
                        function D(c) {
                            c[w] = O++,
                            ...
                            this.promise[w] || D(this.promise),
                                i(e) ? (this._input = e,
                                    ...
                                    0 === this.length ? R(this.promise, this._result) : (this.length = this.length || 0,
                                        this._enumerate(),
                                    0 === this._remaining && R(this.promise, this._result))) : q(this.promise, new Error("Array Methods must be provided an Array"))
                        }
                        function B(c) {
                            this[w] = O++,
                                this._result = this._state = void 0,
                                this._subscribers = [],
                            y !== c && ("function" != typeof c && function() {
                                throw new TypeError("You must pass a resolver function as the first argument to the promise constructor")
                            }(),
                                this instanceof B ? function(c, e) {
                                    try {
                                        e((function(e) {
                                                A(c, e)
                                            }
                        ...
                        return F.prototype._enumerate = function() {
                            for (var c = this.length, e = this._input, a = 0; void 0 === this._state && a < c; a++)
                                this._eachEntry(e[a], a)
                        }
                            ,
                            F.prototype._eachEntry = function(c, e) {
                                var a = this._instanceConstructor
                                    , r = a.resolve;
                                if (r === K) {
                                    var i = S(c);
                                    if (i === _ && void 0 !== c._state)
                            ...
                            ,
                            F.prototype._settledAt = function(c, e, a) {
                                var r = this.promise;
                                void 0 === r._state && (this._remaining--,
                                    2 === c ? q(r, a) : this._result[e] = a),
                                0 === this._remaining && R(r, this._result)
                            }
                            ,
                            F.prototype._willSettleAt = function(c, e) {
                                var a = this;
                                I(c, void 0, (function(c) {
                            ...
                            ,
                            B.all = function(c) {
                                return new F(this,c).promise
                            }
                            ,
                            B.race = function(c) {
                                var e = this;
                                return i(c) ? new e((function(a, r) {
                            ...
                            ,
                            B._setScheduler = function(c) {
                                b = c
                            }
                            ,
                            B._setAsap = function(c) {
                                f = c
                            }
                            ,
                            B._asap = f,
    ...
    , function(c, e, a) {
        ...
        var K = function() {
            ...
            return c.prototype.GetType = function() {
                ...
                ,
                c.prototype.IsEventsRegistered = function() {
                    return this.m_eventsRegistered
                }
                ,
                c.prototype.SetEventsRegistered = function() {
                ...
                c.prototype.Load = function(c) {
                    var e = this;
                    return e.m_loading = !0,
                        new Promise((function(a, i) {
                                e.m_library.AddEventListener(r.EndUserConstants.EndUserEventType.All, c).then((function() {
                                        return e.m_library.GetLibraryInfo(LIBRARY_SETTINGS.downloadsURL)
                                    }
                                )).then((function(c) {
                                        e.m_loading = !1,
                                            e.m_info = c,
